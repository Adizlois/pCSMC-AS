...
# # Example usage
# N <- 1000
# beta <- 1.05                # per-day transmission rate
# infectious_period <- 5      # days => gamma = 0.2/day
# s <- 7
# w <- discretize_gamma_kernel(s = s, mean = 5, sd = 2)  # infectivity kernel over 20 days
# hosp_prob <- 0.1
# sim <- simulate_SIR_with_kernel(
#   T = 100, N = N, beta = beta, infectious_period = infectious_period,hosp_prob=hosp_prob,
#   w = w, I0 = 20, R0_init = 0, stochastic = TRUE, seed = 123
# )
# plot(sim$data$I)
# plot(sim$data$Rt)
